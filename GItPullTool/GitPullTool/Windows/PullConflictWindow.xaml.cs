...
public partial class PullConflictWindow : Window
{
        ...
        string operationName)
    {
        ...
        FileList.ItemsSource = conflictInfo.Files;
    ...
    {
        if (FileList.SelectedItem is not PullConflictFileChange file)
        {
            return;
        }
        ...
        Func<PullConflictFileChange, Task<bool>> actionAsync)
    {
        ...
        try
        {
            var restored = await restoreFileAsync(file);
            if (!restored)
            {
    ...
    private void RefreshSelection()
    {
        ...
        if (FileList.SelectedItem is not PullConflictFileChange)
        {
